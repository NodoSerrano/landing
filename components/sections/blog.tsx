...
function CurvedContainer() {
  return (
    <svg
      ...
      // Safari CPU-rasterises SVG filter regions this large every frame they're
      // on screen during scroll (measured: 0.6-1s frame stalls, ~27fps). CSS
      // drop-shadow is a GPU-composited layer effect, rasterised once.
