...
const VB = "-25 275 2010 1400"

// One <div><svg> layer per blob so each casts its own GPU shadow onto the ones
// behind it (Figma _ddii/_dd per-<g> <filter>; Safari CPU-rasterises those on
// scroll). The warm outline stroke had no Figma shadow — shadow={false}.
