...
// Events blobs are all the same dark #212325, so the shared per-blob shadow
...
const EVENTS_BLOB_SHADOW =
  "drop-shadow(3px 3px 7px rgba(7,15,34,0.26)) drop-shadow(-3px -3px 6px rgba(57,59,91,0.16))"
