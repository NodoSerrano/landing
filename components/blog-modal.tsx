      ...
      {isOpen && (
        <>
          ...
          <motion.div
            ...
            className="fixed top-16 bottom-16 left-4 right-4 z-50 flex flex-col overflow-hidden rounded-xl neumorphism-shadow neumorphism-border shadow-2xl md:top-20 md:bottom-20 md:left-48 md:right-48 lg:top-24 lg:bottom-24 lg:left-72 lg:right-72 xl:top-28 xl:bottom-28 xl:left-96 xl:right-96 2xl:top-32 2xl:bottom-32 2xl:left-[30rem] 2xl:right-[30rem]"
            role="dialog"
            aria-modal="true"
          ...
          >
            ...
            <div className="flex-1 overflow-y-auto scroll-smooth p-4 md:p-5" style={{ scrollbarWidth: 'thin', scrollbarColor: '#475569 #1e293b' }}>
              <article className="mx-auto max-w-3xl">
                      ...
                      {post.tags.length > 0 && (
                        <div className="flex flex-wrap gap-3">
                          {post.tags.map((tag) => (
                            <span
                              key={tag}
                              className="rounded-full neumorphism-shadow neumorphism-border px-3 py-1 text-sm"
                            >
                              #{tag}
                            </span>
                          ))}
                ...
                {/* Article Content */}
                <div className="rounded-xl neumorphism-shadow neumorphism-border p-6 md:p-8">
                  <div 
